 ...
 * runs the real algorithm — the SAME `resultOf` the paper sheet drains, never a
 * second copy — and refuses to let the two disagree.
 */
...
describe('the walkthrough shape', () => {
  ...
  it('names at least two approaches in the cost readout, exactly one of them the winner', () => {
