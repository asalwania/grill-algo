...
import { TOP_K_FREQUENT_ELEMENTS_CHROME } from "./chrome";

/**
 * Top K Frequent Elements' learning view — a thin wrapper that supplies this
...
export function ProblemView(
  ...
  return (
    <ArrayMemoryProblemView
      {...props}
      chrome={TOP_K_FREQUENT_ELEMENTS_CHROME}
      brief={ProblemBrief}
    />
  );
}
