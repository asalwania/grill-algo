...
import { GROUP_ANAGRAMS_CHROME } from "./chrome";

/**
 * Group Anagrams' learning view — a thin wrapper that supplies this problem's
 * chrome and brief to the shared one. Everything else on the page is common to
 * the whole array-plus-memory family.
 *
